...
#      if (!is.null(log.dir)) {    
          save.log( text=raw[1:(line-1)], dir=file.path(cache.dir,"logs"), filename="gages_meta", ext="txt" )
...
#' @seealso \code{\link{headwaters::gage.retrieve}}
#' @export
...
#' @seealso \code{\link{headwaters::gages.retrieve}}
#' @export

gage.place.nhdplus<-function(gages.spatial, cache.dir, server.url="http://felek.cns.umass.edu:9283") {
