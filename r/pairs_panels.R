...
#' Customization of pairs function
#' @param Customization of pairs function. Diagonal displays histograms. Lower panel displays pearson's r, with values above 0.5 or other specified value flagged by coloring red. 
