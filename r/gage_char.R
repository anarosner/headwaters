...
gage.load.impound<-function(gages.spatial, basin.impound.file="C:/ALR/Models_from_others/Kyle/NH NY NHDplus basin zonal stats KO/NENY_CovariateData_Impoundments_2014-01-23.RData") {
                                             #right now, using my local directory as the defaults.  
                                             #this is bad, will replace later, blah blah blah.
...
gage.load.char<-function(gages.spatial, basin.char.file="C:/ALR/Models_from_others/Kyle/NH NY NHDplus basin zonal stats KO/NENY_CovariateData_2014-01-23.RData") {
